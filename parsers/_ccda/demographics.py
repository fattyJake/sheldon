...
def demographics(ccda):
    ...
    language = (
        patient.tag("languageCommunication").tag("languageCode").attr("code")
    )
    ...
    return wrappers.ObjectWrapper(
        ...
        phone=wrappers.ObjectWrapper(home=home, work=work, mobile=mobile),
        email=email,
        language=language,
        race=race,
        ethnicity=ethnicity,
        ...
        guardian=wrappers.ObjectWrapper(
            ...
            phone=wrappers.ObjectWrapper(home=guardian_home),
        ),
