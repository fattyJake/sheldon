...
"""
Parser for the CCDA results section
"""
    ...
    for entry in results.entries():
        ...
        for observation in tests:
            ...
            reference_range_low_unit = (
                el.tag("observationRange").tag("low").attr("unit")
            )
            reference_range_low_value = (
                el.tag("observationRange").tag("low").attr("value")
            )
            reference_range_high_unit = (
                el.tag("observationRange").tag("high").attr("unit")
            )
            reference_range_high_value = (
                el.tag("observationRange").tag("high").attr("value")
            )
