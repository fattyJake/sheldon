 ...
 */"""
GENDER_MAP = {"F": "female", "M": "male", "UN": "undifferentiated"}
...
def _lookup_function_generator(mapping):
    def fn(key):
...
gender = _lookup_function_generator(GENDER_MAP)
marital_status = _lookup_function_generator(MARITAL_STATUS_MAP)
